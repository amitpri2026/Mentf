      ...
      <div class="max-w-3xl mx-auto flex items-center gap-4">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="flex items-center gap-2 mt-0.5">
            ...
            <span v-if="ticket.category" class="text-xs text-slate-400">· {{ ticket.category }}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-3xl mx-auto px-6 py-6 space-y-4">
      ...
      <div class="bg-white rounded-xl border border-slate-200 p-5">
        <div class="flex items-center gap-2 mb-3">
          <p class="text-sm font-semibold text-slate-800">Your Message</p>
      ...
      <div v-for="reply in ticket.replies" :key="reply.id"
        ...
        <div class="flex items-center gap-2 mb-3">
          ...
          <span v-if="reply.is_staff_reply" class="text-xs bg-blue-600 text-white px-2 py-0.5 rounded-full">Support</span>
      ...
      <!-- Reply form -->
      <div v-if="!['resolved', 'closed'].includes(ticket.status)" class="bg-white rounded-xl border border-slate-200 p-5">
        <h3 class="text-sm font-semibold text-slate-800 mb-3">Add Reply</h3>
